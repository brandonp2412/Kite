...
A 2026-09-16 locked Waydroid profile run added the live-location leaf-update journey at the unchanged 16,666 µs budget. The active-to-ended state update captured 1 frame with zero build/raster/total-span violations and worst build/raster/total-span timings of 1,631/4,027/6,136 µs. The location roadmap items remain open because SDK-backed Matrix event ingestion, picker/start/stop workflows, full parity states, and the repository quality gate are not yet satisfied.
