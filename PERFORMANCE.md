...
A later 2026-09-15 Waydroid profile run verified the new mutation benchmarks independently: pagination captured 1 frame at 1,099/1,623/3,209 µs worst build/raster/total-span, incoming-message insertion captured 1 frame at 3,290/1,920/6,050 µs, and 20 reaction/read-receipt/typing updates peaked at 1,204/1,787/3,410 µs. All three had zero build and raster budget violations. Mixed-rich timeline scrolling is intentionally still unchecked: subsequent current-branch profile runs reproduced first-scroll raster violations at 17,636, 27,353, and 22,901 µs with a 16,666 µs budget. An experimental removal of per-row repaint boundaries still missed the contract at 22,901 µs and was reverted. The benchmark threshold remains unchanged while that raster spike is investigated.
